...
const data = [
  ...
  { id: '2', name : 'Stephaine Liver', time : '1 Hour ago', profileimage: require('../assets/img1.png'), message : 'Natural market london is back to life', hashtag : '#London #UK' , videoimage: require('../assets/imgrect.png')  },
  { id: '3', name : 'Stephaine Liver', time : '1 Hour ago', profileimage: require('../assets/img1.png'), message : 'Natural market london is back to life', hashtag : '#London #UK' , videoimage: require('../assets/imgrect.png')  },
            ...
            <View style={styles.profilebar}>
              ...
              <View style={{ marginLeft: 10 }}>
                <TouchableOpacity onPress={() => navigation.navigate('OthersProfile')}>
                  <Text
                    style={{ fontSize: 15, color: 'gray', fontWeight: 'bold' , color:'black'}}>
                    {item.name}
                  </Text>
                </TouchableOpacity>
